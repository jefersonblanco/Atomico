...
<body>
  ...
  <div class="container">
    ...
    <form name="cadastro" id="cadastro" action="<?= base_url("index.php/cadastros/execute/adicionar") ?>">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="idade" name="idade" maxlength="3">
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="telefone" name="telefone" maxlength="16">
      </div>
